...
//
//         // For each gift card, add parameters
//         // This assumes you have a way to handle these parameters on the product page
//         urlParams += `&gift_card_amount[]=${amount}&gift_card_quantity[]=${quantity}`;
//     }
//
//     // Redirect to the product page with parameters
//     window.location.href = 'kringlan1/checkout/?add-to-cart=6362' + urlParams;
// }
//
