...
<p><?php printf( esc_html__( 'Greiðsla fyrir pöntun #%1$s frá %2$s mistókst. Pöntunin var', 'woocommerce' ), esc_html( $order->get_order_number() ), esc_html( $order->get_formatted_billing_full_name() ) ); ?></p>
<?php
